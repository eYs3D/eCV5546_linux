...
/*
 * The OCOTP driver for eYs3D	SP7021
 *
 * Copyright (C) 2019 eys3d Technology Inc., All rights reserved.
 */
...
static const struct of_device_id sp_ocotp_dt_ids[] = {
	{ .compatible = "eys3d,sp7021-ocotp", .data = &sp_otp_v0 },
	{ }
};
...
MODULE_DESCRIPTION("eYs3D On-Chip OTP driver");
MODULE_LICENSE("GPL");
