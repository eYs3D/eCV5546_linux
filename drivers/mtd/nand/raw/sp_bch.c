...
static int eys3d_ooblayout_free(struct mtd_info *mtd, int section,
...
static int eys3d_ooblayout_ecc(struct mtd_info *mtd, int section,
					struct mtd_oob_region *oobregion)
{
	struct sp_bch_chip *chip = &__this;
...
static const struct mtd_ooblayout_ops eys3d_ooblayout_ops = {
	.ecc = eys3d_ooblayout_ecc,
	.free = eys3d_ooblayout_free,
};
...
ecc_detected:
	...
	mtd->ooblayout = &eys3d_ooblayout_ops;
...
MODULE_DESCRIPTION("eYs3D BCH engine driver");
