...
#if defined(CONFIG_USB_EHCI_EYS3D) || defined(CONFIG_USB_OHCI_EYS3D)
...
static const struct of_device_id sp_uphy_dt_ids[] = {
	{.compatible = "eys3d,ecv5546-usb2-phy", },
	{ }
};
...
static int sp_usb_phy_probe(struct platform_device *pdev)
{
	...
	of_property_read_u32(pdev->dev.of_node, "eys3d,disc-vol-addr-off",
...
static struct platform_driver eys3d_usb_phy_driver = {
...
module_platform_driver(eys3d_usb_phy_driver);

MODULE_AUTHOR("Vincent Shih <eys3d@eys3d.com>");
MODULE_DESCRIPTION("eYs3D USB 2.0 phy driver");
MODULE_LICENSE("GPL");
