...
/*
 * eYs3D eCV5546 SoC Display driver for MIPITX block
 *
 ...
 */
//#define eCV5546_MIPI_DSI_1500M_TEST
//#define eCV5546_MIPI_DSI_1200M_TEST
/*
 * use fine tune timing settings
 * and set it before MIPITX module enable
 */
//#define eCV5546_MIPI_DSI_TIMING_NEW
//#define eCV5546_MIPI_DSI_BTA_TEST

void ecv5546_mipitx_init(void)
{
	;//TBD
}

void ecv5546_mipitx_decrypt_info(void)
{
...
EXPORT_SYMBOL(ecv5546_mipitx_decrypt_info);

void ecv5546_mipitx_resolution_chk(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value, mipitx_csi_dt, mipitx_csi_fe;
	u32 mipitx_mode, mipitx_mode1, mipitx_analog_en;
...
EXPORT_SYMBOL(ecv5546_mipitx_resolution_chk);

void ecv5546_mipitx_timing_set(void)
{
	;//TBD
}

void ecv5546_mipitx_timing_get(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value, mipitx_csi_dt, mipitx_csi_fe;
	u32 mipitx_mode, mipitx_mode1, mipitx_analog_en;
...
void ecv5546_mipitx_pllclk_get(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value1, value2;
...
void ecv5546_mipitx_txpll_get(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value1, value2;
	u32 tmp_value1, tmp_value2, tmp_value3;
...
void ecv5546_mipitx_pllclk_init(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
...
#if defined(eCV5546_MIPI_DSI_1500M_TEST)
	{1920, 1080, 0x1, 0x1E, 0x0, 0x0, 0x0, 0x1, 0x8, 0x1, 0x1}, /* 1080P TXPLL 1.5G */
#elif defined(eCV5546_MIPI_DSI_1200M_TEST)
...
void ecv5546_mipitx_pllclk_set(int mode, int width, int height)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	int i, time_cnt = 0;
	u32 value;
	...
	if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_DSI) {
		...
		value = 0x00000000;
		value |= (eCV5546_MIPITX_MIPI_PHY_EN_DIV5(sp_mipitx_phy_pllclk_dsi[time_cnt][6]) |
				eCV5546_MIPITX_MIPI_PHY_POSTDIV(sp_mipitx_phy_pllclk_dsi[time_cnt][5]) |
				eCV5546_MIPITX_MIPI_PHY_FBKDIV(sp_mipitx_phy_pllclk_dsi[time_cnt][3]) |
				eCV5546_MIPITX_MIPI_PHY_PRESCALE(sp_mipitx_phy_pllclk_dsi[time_cnt][2]) |
				eCV5546_MIPITX_MIPI_PHY_PREDIV(sp_mipitx_phy_pllclk_dsi[time_cnt][4]));
		...
		value |= eCV5546_MIPITX_MIPI_PHY_BNKSEL(sp_mipitx_phy_pllclk_dsi[time_cnt][7]);
		...
		value = 0x00000000;
		value |= (eCV5546_MIPITX_MIPI_PHY_EN_DIV5(sp_mipitx_phy_pllclk_csi[time_cnt][6]) |
				eCV5546_MIPITX_MIPI_PHY_POSTDIV(sp_mipitx_phy_pllclk_csi[time_cnt][5]) |
				eCV5546_MIPITX_MIPI_PHY_FBKDIV(sp_mipitx_phy_pllclk_csi[time_cnt][3]) |
				eCV5546_MIPITX_MIPI_PHY_PRESCALE(sp_mipitx_phy_pllclk_csi[time_cnt][2]) |
				eCV5546_MIPITX_MIPI_PHY_PREDIV(sp_mipitx_phy_pllclk_csi[time_cnt][4]));
		writel(value, disp_dev->base + MIPITX_ANALOG_CTRL6); //G205.11

		value = readl(disp_dev->base + MIPITX_ANALOG_CTRL7); //G205.12
		value &= ~(eCV5546_MIPITX_MIPI_PHY_BNKSEL_MASK);
		value |= eCV5546_MIPITX_MIPI_PHY_BNKSEL(sp_mipitx_phy_pllclk_csi[time_cnt][7]);
		writel(value, disp_dev->base + MIPITX_ANALOG_CTRL7); //G205.12
...
void ecv5546_mipitx_gpio_set(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
 ...
 */
void ecv5546_dcs_write_buf(const void *data, size_t len)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	int i;
	u8 *data1;
...
#define ecv5546_dcs_write_seq(seq...)			\
({							\
	const u8 d[] = { seq };			\
	ecv5546_dcs_write_buf(d, ARRAY_SIZE(d));	\
})

void ecv5546_mipitx_panel_init(int mipitx_dev_id, int width, int height)
{
	...
	if (mipitx_dev_id == 0x00001000) {
		...
		ecv5546_mipitx_gpio_set();

		ecv5546_dcs_write_seq(0xB9, 0xF1, 0x12, 0x87);
		ecv5546_dcs_write_seq(0xB2, 0x40, 0x05, 0x78);
		ecv5546_dcs_write_seq(0xB3, 0x10, 0x10, 0x28, 0x28, 0x03, 0xFF, 0x00,
							0x00, 0x00, 0x00);
		ecv5546_dcs_write_seq(0xB4, 0x80);
		ecv5546_dcs_write_seq(0xB5, 0x09, 0x09);
		ecv5546_dcs_write_seq(0xB6, 0x8D, 0x8D);
		ecv5546_dcs_write_seq(0xB8, 0x26, 0x22, 0xF0, 0x63);
		ecv5546_dcs_write_seq(0xBA, 0x33, 0x81, 0x05, 0xF9, 0x0E, 0x0E, 0x20,
							0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x44,
							0x25, 0x00, 0x91, 0x0A, 0x00, 0x00, 0x01, 0x4F,
							0x01, 0x00, 0x00, 0x37);
		ecv5546_dcs_write_seq(0xBC, 0x47);
		ecv5546_dcs_write_seq(0xBF, 0x02, 0x10, 0x00, 0x80, 0x04);
		ecv5546_dcs_write_seq(0xC0, 0x73, 0x73, 0x50, 0x50, 0x00, 0x00, 0x12,
							0x70, 0x00);
		ecv5546_dcs_write_seq(0xC1, 0x65, 0xC0, 0x32, 0x32, 0x77, 0xF4, 0x77,
							0x77, 0xCC, 0xCC, 0xFF, 0xFF, 0x11, 0x11, 0x00,
							0x00, 0x32);
		ecv5546_dcs_write_seq(0xC7, 0x10, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00,
							0x00, 0xED, 0xC7, 0x00, 0xA5);
		ecv5546_dcs_write_seq(0xC8, 0x10, 0x40, 0x1E, 0x03);
		ecv5546_dcs_write_seq(0xCC, 0x0B);
		ecv5546_dcs_write_seq(0xE0, 0x00, 0x04, 0x06, 0x32, 0x3F, 0x3F, 0x36,
							0x34, 0x06, 0x0B, 0x0E, 0x11, 0x11, 0x10, 0x12,
							0x10, 0x13, 0x00, 0x04, 0x06, 0x32, 0x3F, 0x3F,
							0x36, 0x34, 0x06, 0x0B, 0x0E, 0x11, 0x11, 0x10,
							0x12, 0x10, 0x13);
		ecv5546_dcs_write_seq(0xE1, 0x11, 0x11, 0x91, 0x00, 0x00, 0x00, 0x00);
		ecv5546_dcs_write_seq(0xE3, 0x03, 0x03, 0x0B, 0x0B, 0x00, 0x03, 0x00,
							0x00, 0x00, 0x00, 0xFF, 0x84, 0xC0, 0x10);
		ecv5546_dcs_write_seq(0xE9, 0xC8, 0x10, 0x06, 0x05, 0x18, 0xD2, 0x81,
		...
		ecv5546_dcs_write_seq(0xEA, 0x96, 0x0C, 0x01, 0x01, 0x00, 0x00, 0x00,
		...
		ecv5546_dcs_write_seq(0xEF, 0xFF, 0xFF, 0x01);

		ecv5546_dcs_write_seq(0x36, 0x14);
		ecv5546_dcs_write_seq(0x35, 0x00);
		ecv5546_dcs_write_seq(0x11);
		mdelay(120);
		ecv5546_dcs_write_seq(0x29);
		mdelay(20);
		...
		ecv5546_dcs_write_seq(0xDF, 0x98, 0x51, 0xE9);

		/* Page 00 setting */
		ecv5546_dcs_write_seq(0xDE, 0x00);
		ecv5546_dcs_write_seq(0xB7, 0x22, 0x85, 0x22, 0x2B);
		ecv5546_dcs_write_seq(0xC8, 0x3F, 0x38, 0x33, 0x2F, 0x32, 0x34, 0x2F,
							0x2F, 0x2D, 0x2C, 0x27, 0x1A, 0x14, 0x0A, 0x06,
							0x0E, 0x3F, 0x38, 0x33, 0x2F, 0x32, 0x34, 0x2F,
							0x2F, 0x2D, 0x2C, 0x27, 0x1A, 0x14, 0x0A, 0x06,
							0x0E);
		ecv5546_dcs_write_seq(0xB9, 0x33, 0x08, 0xCC);
		ecv5546_dcs_write_seq(0xBB, 0x46, 0x7A, 0x30, 0x40, 0x7C, 0x60, 0x70,
							0x70);
		ecv5546_dcs_write_seq(0xBC, 0x38, 0x3C);
		ecv5546_dcs_write_seq(0xC0, 0x31, 0x20);
		ecv5546_dcs_write_seq(0xC1, 0x12);
		ecv5546_dcs_write_seq(0xC3, 0x08, 0x00, 0x0A, 0x10, 0x08, 0x54, 0x45,
							0x71, 0x2C);
		ecv5546_dcs_write_seq(0xC4, 0x00, 0xA0, 0x79, 0x0E, 0x0A, 0x16, 0x79,
							0x0E, 0x0A, 0x16, 0x79, 0x0E, 0x0A, 0x16, 0x82,
							0x00, 0x03);
		ecv5546_dcs_write_seq(0xD0, 0x04, 0x0C, 0x6B, 0x0F, 0x07, 0x03);
		ecv5546_dcs_write_seq(0xD7, 0x13, 0x00);

		/* Page 02 setting */
		ecv5546_dcs_write_seq(0xDE, 0x02);
		mdelay(1);
		ecv5546_dcs_write_seq(0xB8, 0x1D, 0xA0, 0x2F, 0x04, 0x33);
		ecv5546_dcs_write_seq(0xC1, 0x10, 0x66, 0x66, 0x01);

		/* Page 00 setting */
		ecv5546_dcs_write_seq(0xDE, 0x00);
		//ecv5546_dcs_write_seq(0xC2, 0x08); /* BIST_EN */
		ecv5546_dcs_write_seq(0x11);
		mdelay(120);
		...
		ecv5546_dcs_write_seq(0xDE, 0x02);
		mdelay(1);
		ecv5546_dcs_write_seq(0xC5, 0x4E, 0x00, 0x00);
		mdelay(1);
		ecv5546_dcs_write_seq(0xCA, 0x30, 0x20, 0xF4);
		mdelay(1);

		/* Page 04 setting */
		ecv5546_dcs_write_seq(0xDE, 0x04);
		mdelay(1);
		ecv5546_dcs_write_seq(0xD3, 0x3C);
		mdelay(1);
		...
		ecv5546_dcs_write_seq(0x10, 0x02, 0x03, 0x00, 0x00, 0x00); /*dsi DSI_LANEENABLE = 0x0210*/
		ecv5546_dcs_write_seq(0x64, 0x01, 0x05, 0x00, 0x00, 0x00); /*dsi PPI_D0S_CLRSIPOCOUNT = 0x0164*/
		ecv5546_dcs_write_seq(0x68, 0x01, 0x05, 0x00, 0x00, 0x00); /*dsi PPI_D1S_CLRSIPOCOUNT = 0x0168*/
		ecv5546_dcs_write_seq(0x44, 0x01, 0x00, 0x00, 0x00, 0x00); /*dsi PPI_D0S_ATMR = 0x0144*/
		ecv5546_dcs_write_seq(0x48, 0x01, 0x00, 0x00, 0x00, 0x00); /*dsi PPI_D1S_ATMR = 0x0148*/
		ecv5546_dcs_write_seq(0x14, 0x01, 0x03, 0x00, 0x00, 0x00); /*dsi PPI_LPTXTIMECNT = 0x0114*/

		ecv5546_dcs_write_seq(0x50, 0x04, 0x00, 0x00, 0x00, 0x00); /*dsi SPICMR = 0x0450*/
		ecv5546_dcs_write_seq(0x20, 0x04, 0x50, 0x01, 0x10, 0x00); /*dsi LCDCTRL = 0x0420*/
		ecv5546_dcs_write_seq(0x64, 0x04, 0x0f, 0x04, 0x00, 0x00); /*dsi SYSCTRL = 0x0464*/
		mdelay(100); //msleep(100);
		ecv5546_dcs_write_seq(0x04, 0x01, 0x01, 0x00, 0x00, 0x00); /*dsi PPI_STARTPPI = 0x0104*/
		ecv5546_dcs_write_seq(0x04, 0x02, 0x01, 0x00, 0x00, 0x00); /*dsi DSI_STARTDSI = 0x0204*/
		mdelay(100); //msleep(100);
...
#ifdef eCV5546_MIPI_DSI_TIMING_NEW
/*
...
void ecv5546_mipitx_phy_init(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value;
	...
	if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_DSI) {
		if (disp_dev->mipitx_format == 0x0)
			...
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_DSI_RGB888);
	} else { //if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_CSI) {
		if (disp_dev->mipitx_format == 0x0)
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_CSI_16BITS);
		else if (disp_dev->mipitx_format == 0x1)
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_CSI_16BITS);
		else if (disp_dev->mipitx_format == 0x2)
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_CSI_YUV422_20BITS);
		else if (disp_dev->mipitx_format == 0x3)
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_CSI_24BITS);
		else
			value |= eCV5546_MIPITX_FORMAT_VPF_SET(eCV5546_MIPITX_VPF_CSI_24BITS);
	}
	...
	value |= eCV5546_MIPITX_NORMAL; //PHY Reset(under normal mode)
	writel(value, disp_dev->base + MIPITX_ANALOG_CTRL2); //G205.06
}

#ifndef eCV5546_MIPI_DSI_TIMING_NEW
/*
 * sp_mipitx_output_timing[x]
 * x = 0-10, MIPITX phy
 *   T_HS-EXIT / T_LPX
...
void ecv5546_mipitx_lane_control_set(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value = 0;
...
void ecv5546_mipitx_cmd_mode_start(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value;
...
static const u32 sp_mipitx_input_timing_dsi[11][10] = {
	...
	{ 720,  480, 0x3e,  0, 0x3c,  0, 0x6, 0x9, 0x1E,  480}, /* 480P */
...
void ecv5546_mipitx_video_mode_setting(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	...
	if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_DSI) {
		...
		if ((disp_dev->mipitx_lane == 1) && (width == 240) && (height == 320))
			//value |= eCV5546_MIPITX_HSA_SET(0x6) |
			value |= eCV5546_MIPITX_HSA_SET(sp_mipitx_input_timing_dsi[time_cnt][2]) |
				eCV5546_MIPITX_HFP_SET(sp_mipitx_input_timing_dsi[time_cnt][3]) |
				eCV5546_MIPITX_HBP_SET(sp_mipitx_input_timing_dsi[time_cnt][4]);
		else
			value |= eCV5546_MIPITX_HSA_SET(sp_mipitx_input_timing_dsi[time_cnt][2]) |
				eCV5546_MIPITX_HFP_SET(sp_mipitx_input_timing_dsi[time_cnt][3]) |
				eCV5546_MIPITX_HBP_SET(sp_mipitx_input_timing_dsi[time_cnt][4]);
		...
		value = 0;
		value |= eCV5546_MIPITX_VSA_SET(sp_mipitx_input_timing_dsi[time_cnt][6]) |
			eCV5546_MIPITX_VFP_SET(sp_mipitx_input_timing_dsi[time_cnt][7]) |
			eCV5546_MIPITX_VBP_SET(sp_mipitx_input_timing_dsi[time_cnt][8]);
		writel(value, disp_dev->base + MIPITX_VM_VT0_CTRL);

		value = 0;
		value |= eCV5546_MIPITX_VACT_SET(sp_mipitx_input_timing_dsi[time_cnt][9]);
		...
		if (disp_dev->mipitx_lane == 1)
			value |= eCV5546_MIPITX_HSA_SET(0x6) |
				eCV5546_MIPITX_HFP_SET(sp_mipitx_input_timing_csi[time_cnt][3]) |
				eCV5546_MIPITX_HBP_SET(sp_mipitx_input_timing_csi[time_cnt][4]);
		else
			value |= eCV5546_MIPITX_HSA_SET(sp_mipitx_input_timing_csi[time_cnt][2]) |
				eCV5546_MIPITX_HFP_SET(sp_mipitx_input_timing_csi[time_cnt][3]) |
				eCV5546_MIPITX_HBP_SET(sp_mipitx_input_timing_csi[time_cnt][4]);
		writel(value, disp_dev->base + MIPITX_VM_HT_CTRL);

		value = 0;
		value |= eCV5546_MIPITX_VSA_SET(sp_mipitx_input_timing_csi[time_cnt][6]) |
			eCV5546_MIPITX_VFP_SET(sp_mipitx_input_timing_csi[time_cnt][7]) |
			eCV5546_MIPITX_VBP_SET(sp_mipitx_input_timing_csi[time_cnt][8]);
		writel(value, disp_dev->base + MIPITX_VM_VT0_CTRL);

		value = 0;
		value |= eCV5546_MIPITX_VACT_SET(sp_mipitx_input_timing_csi[time_cnt][9]);
		writel(value, disp_dev->base + MIPITX_VM_VT1_CTRL);
...
void ecv5546_mipitx_csi_setting(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value, vfp;
	...
	value = 0x00000000;
	value |= eCV5546_MIPITX_MIPI_CSI_MODE_EN;
	value |= eCV5546_MIPITX_MIPI_CSI_FE_SET((vfp - 1));
	if (disp_dev->mipitx_format == 0x0)
		value |= eCV5546_MIPITX_MIPI_CSI_DT_SET(eCV5546_MIPITX_MIPI_CSI_DT_RGB565);
	else if (disp_dev->mipitx_format == 0x1)
		value |= eCV5546_MIPITX_MIPI_CSI_DT_SET(eCV5546_MIPITX_MIPI_CSI_DT_YUV422_8bit);
	else if (disp_dev->mipitx_format == 0x2)
		value |= eCV5546_MIPITX_MIPI_CSI_DT_SET(eCV5546_MIPITX_MIPI_CSI_DT_YUV422_10bit);
	else if (disp_dev->mipitx_format == 0x3)
		value |= eCV5546_MIPITX_MIPI_CSI_DT_SET(eCV5546_MIPITX_MIPI_CSI_DT_RGB888);
	else
		value |= eCV5546_MIPITX_MIPI_CSI_DT_SET(eCV5546_MIPITX_MIPI_CSI_DT_RGB888);
...
void ecv5546_mipitx_video_mode_on(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value;
...
void ecv5546_mipitx_phy_init_dsi(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 width, height;
	...
	ecv5546_mipitx_phy_init();

	ecv5546_mipitx_pllclk_init();

	//if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_DSI) {
	if (disp_dev->mipitx_dev_id == 0x00001000) {
		ecv5546_mipitx_cmd_mode_start();
		//transfer data from TX to RX (depends on panel manufacturer)
		#ifndef eCV5546_MIPI_DSI_BTA_TEST //for BTA test
		ecv5546_mipitx_panel_init(0x00001000, width, height);
		#endif
	} else if (disp_dev->mipitx_dev_id == 0x00001001) {
		ecv5546_mipitx_cmd_mode_start();
		//transfer data from TX to RX (depends on panel manufacturer)
		#ifndef eCV5546_MIPI_DSI_BTA_TEST //for BTA test
		ecv5546_mipitx_panel_init(0x00001001, width, height);
		#endif
	} else if (disp_dev->mipitx_dev_id == 0x00001002) {
		ecv5546_mipitx_cmd_mode_start();
		//transfer data from TX to RX (depends on panel manufacturer)
		#ifndef eCV5546_MIPI_DSI_BTA_TEST //for BTA test
		ecv5546_mipitx_panel_init(0x00001002, width, height);
		#endif
	}

#ifndef eCV5546_MIPI_DSI_BTA_TEST //for BTA test

	ecv5546_mipitx_pllclk_set(eCV5546_MIPITX_HS_MODE, width, height);

	ecv5546_mipitx_video_mode_setting();

	ecv5546_mipitx_lane_control_set();

	if (disp_dev->out_res.mipitx_mode == eCV5546_MIPITX_CSI)
		ecv5546_mipitx_csi_setting();

	ecv5546_mipitx_video_mode_on();

#endif
}

void ecv5546_mipitx_phy_init_csi(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 width, height, data_bit;
...
void ecv5546_mipitx_phy_get(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
...
void ecv5546_mipitx_store(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
	u32 value, i;
...
void ecv5546_mipitx_restore(void)
{
	struct sp_disp_device *disp_dev = gdisp_dev;
