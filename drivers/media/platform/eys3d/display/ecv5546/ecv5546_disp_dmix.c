...
void ecv5546_dmix_init(void)
{
	 ...
	 */
	value = 0;
	value |= eCV5546_DMIX_L6_FG_SEL(eCV5546_DMIX_OSD0_SEL) |
		eCV5546_DMIX_L5_FG_SEL(eCV5546_DMIX_OSD1_SEL) |
		eCV5546_DMIX_L4_FG_SEL(eCV5546_DMIX_OSD2_SEL) |
		eCV5546_DMIX_L3_FG_SEL(eCV5546_DMIX_OSD3_SEL) |
		eCV5546_DMIX_L2_FG_SEL(eCV5546_DMIX_VPP1_SEL) |
		eCV5546_DMIX_L1_FG_SEL(eCV5546_DMIX_VPP0_SEL) |
		eCV5546_DMIX_BG_FG_SEL(eCV5546_DMIX_PTG_SEL);
	 ...
	 */
	value = 0;
	value |= eCV5546_DMIX_L6_MODE_SEL(eCV5546_DMIX_TRANSPARENT) |
		eCV5546_DMIX_L5_MODE_SEL(eCV5546_DMIX_TRANSPARENT) |
		eCV5546_DMIX_L4_MODE_SEL(eCV5546_DMIX_TRANSPARENT) |
		eCV5546_DMIX_L3_MODE_SEL(eCV5546_DMIX_TRANSPARENT) |
		eCV5546_DMIX_L2_MODE_SEL(eCV5546_DMIX_TRANSPARENT) |
		eCV5546_DMIX_L1_MODE_SEL(eCV5546_DMIX_TRANSPARENT);
	 ...
	 */
	value = 0;
	value |= eCV5546_DMIX_PTG_BORDER_PATTERN(eCV5546_DMIX_PTG_BORDER) |
		eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_00);
	 ...
	 */
	value =0;
	value |= eCV5546_DMIX_SOURCE_SEL(eCV5546_DMIX_TCON0_DMIX);
...
EXPORT_SYMBOL(ecv5546_dmix_decrypt_info);
...
EXPORT_SYMBOL(ecv5546_dmix_all_layer_info);
...
EXPORT_SYMBOL(ecv5546_dmix_bist_info);
...
void ecv5546_dmix_ptg_set(int pattern_sel, int bg_color_yuv)
{
	...
	switch (pattern_sel) {
		case eCV5546_DMIX_BIST_BGC:
		case eCV5546_DMIX_BIST_BORDER:
			value |= eCV5546_DMIX_PTG_BORDER_PATTERN(eCV5546_DMIX_PTG_BORDER) |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value2 |= bg_color_yuv;
			break;
		case eCV5546_DMIX_BIST_BORDER_NONE:
			value |= eCV5546_DMIX_PTG_BORDER_PATTERN(eCV5546_DMIX_PTG_BORDER) |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_00);
			value2 |= bg_color_yuv;
			break;
		case eCV5546_DMIX_BIST_BORDER_ONE:
			value |= eCV5546_DMIX_PTG_BORDER_PATTERN(eCV5546_DMIX_PTG_BORDER) |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_01);
			value2 |= bg_color_yuv;
			break;
		case eCV5546_DMIX_BIST_COLORBAR_ROT0:
			value |= eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value2 |= eCV5546_DMIX_PTG_BLACK;
			break;
		case eCV5546_DMIX_BIST_COLORBAR_ROT90:
			value |= eCV5546_DMIX_PTG_COLOR_BAR_ROTATE |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value2 |= eCV5546_DMIX_PTG_BLACK;
			break;
		case eCV5546_DMIX_BIST_SNOW:
			value |= eCV5546_DMIX_PTG_COLOR_BAR_SNOW |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value1 |= eCV5546_DMIX_PTG_V_DOT_SET(eCV5546_DMIX_PTG_DOT_00) |
				eCV5546_DMIX_PTG_H_DOT_SET(eCV5546_DMIX_PTG_DOT_00);
			value2 |= eCV5546_DMIX_PTG_BLACK;
			break;
		case eCV5546_DMIX_BIST_SNOW_HALF:
			value |= eCV5546_DMIX_PTG_COLOR_BAR_SNOW |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value1 |= eCV5546_DMIX_PTG_V_DOT_SET(eCV5546_DMIX_PTG_DOT_07) |
				eCV5546_DMIX_PTG_H_DOT_SET(eCV5546_DMIX_PTG_DOT_07);
			value2 |= eCV5546_DMIX_PTG_BLACK;
			break;
		case eCV5546_DMIX_BIST_SNOW_MAX:
			value |= eCV5546_DMIX_PTG_COLOR_BAR_SNOW |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value1 |= eCV5546_DMIX_PTG_V_DOT_SET(eCV5546_DMIX_PTG_DOT_15) |
				eCV5546_DMIX_PTG_H_DOT_SET(eCV5546_DMIX_PTG_DOT_15);
			value2 |= eCV5546_DMIX_PTG_BLACK;
			break;
		case eCV5546_DMIX_BIST_REGION:
			value |= eCV5546_DMIX_PTG_BORDER_PATTERN(eCV5546_DMIX_PTG_REGION) |
				eCV5546_DMIX_PTG_BORDER_PIX(eCV5546_DMIX_PTG_BORDER_PIX_07);
			value2 |= bg_color_yuv;
			break;
		default:
...
void ecv5546_dmix_layer_init(int layer, int fg_sel, int layer_mode)
{
	...
	switch (fg_sel) {
		case eCV5546_DMIX_VPP0:
			input = eCV5546_TGEN_DTG_ADJ_VPP0;
			break;
		case eCV5546_DMIX_OSD0:
			input = eCV5546_TGEN_DTG_ADJ_OSD0;
			break;
		case eCV5546_DMIX_OSD1:
			input = eCV5546_TGEN_DTG_ADJ_OSD1;
			break;
		case eCV5546_DMIX_OSD2:
			input = eCV5546_TGEN_DTG_ADJ_OSD2;
			break;
		case eCV5546_DMIX_OSD3:
			input = eCV5546_TGEN_DTG_ADJ_OSD3;
			break;
		case eCV5546_DMIX_PTG:
			input = eCV5546_TGEN_DTG_ADJ_PTG;
			break;
		default:
			input = eCV5546_TGEN_DTG_ADJ_ALL;
			break;
	}
	if (input != eCV5546_TGEN_DTG_ADJ_ALL) {
		if (input == eCV5546_TGEN_DTG_ADJ_PTG)
			ecv5546_tgen_input_adjust(input, 0x10);
		else
			ecv5546_tgen_input_adjust(input, 0x10 - ((layer - eCV5546_DMIX_L1) << 1));
	}
}
...
void ecv5546_dmix_layer_cfg_set(int layer_id)
{
	...
	if (layer_id == 0) {
		...
		//#ifdef CONFIG_DRM_eCV5546
		//ecv5546_dmix_layer_init(eCV5546_DMIX_L3, eCV5546_DMIX_VPP0, eCV5546_DMIX_TRANSPARENT);
		//ecv5546_dmix_layer_init(eCV5546_DMIX_L1, eCV5546_DMIX_OSD3, eCV5546_DMIX_TRANSPARENT);
		//#else
...
void ecv5546_dmix_color_adj_onoff(int enable)
{
	...
	if (enable)
		value |= eCV5546_DMIX_LUMA_ADJ_EN | eCV5546_DMIX_CRMA_ADJ_EN;
	else
		value &= ~(eCV5546_DMIX_LUMA_ADJ_EN | eCV5546_DMIX_CRMA_ADJ_EN);
