...
static int usb_extcon_probe(struct platform_device *pdev)
{
	...
	struct device_node *phynp = of_find_compatible_node(NULL, NULL, "eys3d,usb3-phy");
...
MODULE_AUTHOR("ChingChouHuang <eys3d@eys3d.com>");
MODULE_DESCRIPTION("eYs3D USB GPIO extcon driver");
