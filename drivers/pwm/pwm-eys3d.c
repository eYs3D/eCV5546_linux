...
/*
 * PWM device driver for EYS3D SP7021 SoC
 *
 * Links:
 *   Reference Manual:
 *   https://eys3d-tibbo.atlassian.net/wiki/spaces/doc/overview
 *
 *   Reference Manual(PWM module):
 *   https://eys3d.atlassian.net/wiki/spaces/doc/pages/461144198/12.+Pulse+Width+Modulation+PWM
 *
 * Limitations:
