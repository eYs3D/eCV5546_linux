...
/*
 * Copyright (c) eys3d Inc.
 * Author: Tony Huang <tonyhuang.eys3d@gmail.com>
...
MODULE_AUTHOR("Tony Huang <tonyhuang.eys3d@gmail.com>");
MODULE_AUTHOR("Li-hao Kuo <lhjeff911@gmail.com>");
MODULE_DESCRIPTION("eYs3D MMC controller driver");
MODULE_LICENSE("GPL");
