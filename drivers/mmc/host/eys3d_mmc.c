...
static const struct mmc_host_ops spmmc_ops = {
	...
	.get_cd = spmmc_get_cd,
#ifdef SPMMC_SUPPORT_VOLTAGE_1V8
#ifdef PLATFORM_eCV5546 // Q645 don't need run this function. Becasue MMC test have -110 error.
...
MODULE_AUTHOR("zy.bai <eys3d@eys3d.com>");
MODULE_DESCRIPTION("eYs3D MMC/SD/SDIO host controller v3.0 driver");
