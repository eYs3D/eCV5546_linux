...
static inline unsigned int mask_set(unsigned int mask)
{
	return (mask | (mask << 16));
}
...
MODULE_AUTHOR("Xiantao Hu <eys3d@eys3d.com>");
MODULE_DESCRIPTION("eYs3D Watchdog Timer Driver");
