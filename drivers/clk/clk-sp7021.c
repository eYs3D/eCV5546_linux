...
/*
 * Copyright (C) eys3d Technology Co., Ltd.
 *       All rights reserved.
 */
...
#include <dt-bindings/clock/eys3d,sp7021-clkc.h>
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Clock driver for eYs3D SP7021 SoC");
