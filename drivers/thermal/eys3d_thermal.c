...
struct eys3d_thermal_compatible {
	int ver;
	int temp_base;
	int temp_otp_base;
	int temp_rate;
...
struct sp_thermal_data {
	...
	const struct eys3d_thermal_compatible *dev_comp;
...
static const struct eys3d_thermal_compatible ecv5546_compat = {
	.ver = 2,
	.temp_base = 3500,
	.temp_otp_base = 1496,
	.temp_rate = 585,
...
static const struct of_device_id of_sp_thermal_ids[] = {
	{ .compatible = "eys3d,ecv5546-thermal", (void *)&ecv5546_compat },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, of_sp_thermal_ids);

static struct platform_driver eys3d_thermal_driver = {
...
module_platform_driver(eys3d_thermal_driver);

MODULE_AUTHOR("Li-hao Kuo <lhjeff911@gmail.com>");
MODULE_DESCRIPTION("Thermal driver for eys3d SoC");
MODULE_LICENSE("GPL");
