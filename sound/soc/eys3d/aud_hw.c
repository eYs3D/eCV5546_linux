...
#if IS_MODULE(CONFIG_SND_SOC_AUD_eCV5546)
...
{
	struct eys3d_audio_base *pauddrvdata = auddrvdata;
	u32 val;
...
void AUDHW_SystemInit(void *auddrvdata)
{
	...
	regs0->pcm_cfg		= 0x71;	//ecv5546 tx0
	regs0->ext_adc_cfg	= 0x71;	//rx0
	regs0->hdmi_tx_i2s_cfg	= 0x71;	//ecv5546 tx2 if tx2(slave) -> rx0 -> tx1/tx0  0x24d
...
#if IS_ENABLED(CONFIG_SND_SOC_ES8316_EYS3D) || IS_ENABLED(CONFIG_SND_SOC_ES8326_EYS3D)
