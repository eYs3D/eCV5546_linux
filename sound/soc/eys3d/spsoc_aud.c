...
#if IS_ENABLED(CONFIG_SND_SOC_ES8326_EYS3D)
...
static struct snd_soc_card spsoc_smdk =	{
	...
	.long_name	= "eCV5546, eYs3D Technology Inc.",
	.owner		= THIS_MODULE,
...
MODULE_DESCRIPTION("eYs3D eCV5546 audio card driver");
MODULE_LICENSE("GPL");
